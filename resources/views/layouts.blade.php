...
<html class="no-js" lang="en">
    <head>
        <title>Pelita Charcoal – Bricket Coal</title>
        <meta charset="utf-8">
        ...
        <link rel="stylesheet" type="text/css" href="/pub/css/font-icons.min.css">
        <link rel="stylesheet" type="text/css" href="/pub/css/theme-vendors.min.css">
        <link rel="stylesheet" type="text/css" href="/pub/css/style.css" />
        <link rel="stylesheet" type="text/css" href="/pub/css/responsive.css" />
        <!-- revolution slider -->
        <link rel="stylesheet" type="text/css" href="/pub/revolution/css/settings.css">
        <link rel="stylesheet" type="text/css" href="/pub/revolution/css/layers.css">
        <link rel="stylesheet" type="text/css" href="/pub/revolution/css/navigation.css">
    </head>
    <body data-mobile-nav-style="classic">
                ...
                <div class="container-fluid nav-header-container">
                    <div class="col-auto col-sm-6 col-lg-2 mr-auto pl-lg-0">
                        <a class="navbar-brand" href="index.html">
                            <img src="/pub/images/logo-white.png" data-at2x="/pub/images/logo-white@2x.png" class="default-logo" alt="">
                            <img src="/pub/images/logo-green-dark.png" data-at2x="/pub/images/logo-green-dark@2x.png" class="alt-logo" alt="">
                            <img src="/pub/images/logo-green-dark.png" data-at2x="/pub/images/logo-green-dark@2x.png" class="mobile-logo" alt="">
                        </a>
                    </div>
                ...
                <div class="container"> 
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-sm-8 text-center text-sm-right last-paragraph-no-margin">
                            <p>&copy; 2021 Litho is Proudly Powered by <a href="https://www.themezaa.com/" target="_blank" class="text-decoration-line-bottom text-extra-dark-gray font-weight-500">ThemeZaa</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @yield("footer")
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/js/jquery.min.js"></script>
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/js/theme-vendors.min.js"></script>
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/js/main.js"></script>

        <!-- revolution js files -->
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/revolution/js/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/revolution/js/jquery.themepunch.revolution.min.js"></script>

        <script type="text/javascript" src="{{ URL::to('/') }}/pub/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
        <script type="text/javascript" src="{{ URL::to('/') }}/pub/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
